...
// =============================================================================
// Generators (reuses genUserID from jwt_property_test.go)
// =============================================================================
...
// genRegistrationEmail generates valid email addresses for registration tests
// Note: Uses different name than genEmail in jwt_property_test.go to avoid conflict
func genRegistrationEmail() gopter.Gen {
...
// Note: genUserID is already defined in jwt_property_test.go and is reused here
// since both files are in the same package (auth)
